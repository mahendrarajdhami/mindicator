package com.deltatechnepal.circularindicator;
...
/**
 * Created by DeltaTech on 5/16/2018.
 */
...
public class CircularIndicator extends View{
    ...
    public CircularIndicator(Context context, @Nullable AttributeSet attrs) {
        super(context, attrs);
        init(context, attrs);
    }

    public CircularIndicator(Context context, @Nullable AttributeSet attrs, int defStyleAttr) {
        super(context, attrs, defStyleAttr);
        init(context, attrs);
    }

    @TargetApi(Build.VERSION_CODES.LOLLIPOP)
    public CircularIndicator(Context context, @Nullable AttributeSet attrs, int defStyleAttr, int defStyleRes) {
    ...
    private void init(@NonNull Context context, @Nullable AttributeSet attrs) {
        ...
        if (attrs != null) {
            TypedArray a = context.obtainStyledAttributes(attrs, R.styleable.CircularIndicator);

            progressColor = a.getColor(R.styleable.CircularIndicator_progressColor, progressColor);
            progressBackgroundColor = a.getColor(R.styleable.CircularIndicator_progressBackgroundColor, progressBackgroundColor);
            progressStrokeWidth = a.getDimensionPixelSize(R.styleable.CircularIndicator_progressStrokeWidth, progressStrokeWidth);
            textColor = a.getColor(R.styleable.CircularIndicator_textColor, progressColor);
            textSize = a.getDimensionPixelSize(R.styleable.CircularIndicator_textSize, textSize);

            shouldDrawDot = a.getBoolean(R.styleable.CircularIndicator_drawDot, shouldDrawDot);
            dotColor = a.getColor(R.styleable.CircularIndicator_dotColor, progressColor);
            dotWidth = a.getDimensionPixelSize(R.styleable.CircularIndicator_dotWidth, progressStrokeWidth);

            shouldUseDelimiter = a.getBoolean(R.styleable.CircularIndicator_useProgressTextDelimiter, shouldUseDelimiter);
            progressTextDelimiter = a.getString(R.styleable.CircularIndicator_progressTextDelimiter);
            progressTextPrefix = a.getString(R.styleable.CircularIndicator_progressTextPrefix);
            progressTextSuffix = a.getString(R.styleable.CircularIndicator_progressTextSuffix);
    ...
    public void setProgressText(String tempText) {

        progressText = tempText;
